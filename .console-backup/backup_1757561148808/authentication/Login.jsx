...
export default function Login({ showGuest = true, onForgotPassword, onSignUp }) {
  ...
  const handleGoogleLogin = async () => {
    ...
    console.log('🔧 Config webClientId:', Config.GOOGLE_WEB_CLIENT_ID);
    
    try {
      // Cerrar sesión silenciosamente para mostrar selector de cuenta
      try {
        console.log('🔄 Intentando signOut silencioso...');
      ...
      console.log('🔐 Iniciando GoogleSignin.signIn()...');
      ...
      if (error.code === statusCodes.SIGN_IN_CANCELLED) {
        ...
        console.log('❌ Error no categorizado - mostrando mensaje genérico');
        console.log('🚨 ESTE ES EL ERROR QUE NECESITAMOS INVESTIGAR');
        showAlert({
          type: 'error',
